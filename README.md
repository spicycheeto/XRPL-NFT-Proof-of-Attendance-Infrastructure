...
In order to facilitate storing json files with a public uri XummApi.js and continue using the site without the need for a db solution XummApi.js has was introduced.
